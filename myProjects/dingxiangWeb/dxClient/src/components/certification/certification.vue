  ...
  <div class="listout">
    <div class="listleft">
      <div class="news-active border">
        <div class="model-title">产品认证</div>
    ...
    <div class="listright">
      <listview :listtype="8" :toptitle="toptitle" :listInfoAry="listAry"></listview>
...
export default {
  ...
  methods: {
    ...
    changeType(idx, event) {
      ...
      this.toptitle = `新闻动态>${event.target.textContent}`;
    },
    pageChange(pInfo) {
      let queryObj = {
  ...
  created() {},
  mounted() {
    let queryObj = { pageSize: 10, pageNum: 1, Type: 4 };
    this.listInfo(queryObj);
  }
};
</script>
