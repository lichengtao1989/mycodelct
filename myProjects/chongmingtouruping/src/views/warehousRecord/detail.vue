<template>
  <div class="listwrap" v-tab-title="'详情列表'" v-hide-menu="true">
    ...
    <nz-list :requestUrl="$apiUrl.STOCK.GETDETAIL" :beforeSearch="beforeSearch" ref="list" :needAdvancedSearch="false" :needBaseSearch="false">
      <div slot="search">
      ...
      <template slot="tableColumns">
        ...
        <nz-table-column prop="Amount" min-width="120" label="数量" sortable="custom"></nz-table-column>
        ...
        <nz-table-column prop="InStockTime" min-width="120" label="入库日期" sortable="custom"></nz-table-column>
