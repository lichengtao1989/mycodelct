  ...
  <div class="detailinfocp" id="pdetaillct">
    ...
    <div class="nextinfo">
      ...
      <div class="right">
        <div class="sm1">
          <div class="inline">
            <span class="w80">品牌</span>{{infoData.ProductBrand}}</div>
          <div class="inline">
            <span class="w80">联系方式</span>{{infoData.ContactInfo}}</div>
        </div>
        <div class="sm1">
          <div class="inline">
            <span class="w80">生产企业</span> {{infoData.Producer}}</div>
          <div class="inline">
            <span class="w80">保质期</span> {{infoData.ShelfLife}}天</div>
        </div>
        <div class="sm2">
...
.imgss{display:block;height: 100%;}
.detailinfocp {
  @include ba(#fff);
  margin-top: 10px;
  width: 100%;
