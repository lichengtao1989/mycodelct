<template>
  <div class="content">
    <nz-form label-width="150px" ref="form" :model="form" :rules="rules">
      <nz-form-item label="资讯类别" prop="type" required>
        <nz-enum-select v-model="form.type" is-select :options="$enum('资讯类别').values"></nz-enum-select>
      </nz-form-item>
      ...
      <nz-form-item label="概要" prop="outline">
        <nz-input v-model="form.outline"></nz-input>
      </nz-form-item>
