<template>
  <textarea :id="'cjm_editor_'+editorId" v-html="value">
  </textarea>
</template>
...
<script>
  ...
  export default {
    ...
    mounted(){
      let self = this;
      this.editor = window.KindEditor.create('#cjm_editor_' + this.editorId, {
        ...
        items: [
          ...
          'insertunorderedlist', '|', 'flash', 'media', 'image', 'link'],
        afterBlur: function () {
