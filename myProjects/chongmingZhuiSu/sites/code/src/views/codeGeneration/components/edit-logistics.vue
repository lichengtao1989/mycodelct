<template>
  <cjm-form ref="form" :model="form" :rules="rules">
      <cjm-form-item label="防伪生效时间" prop="antiFakeEnableTime" required class="cjm-form-item-long">
        <cjm-radio-group v-model="form.antiFakeEnableTime">
          <cjm-radio :label="value" v-for="(value,key) in antiFakeEnableTime" :key="value"
                     :disabled="operation==='approve' || operation==='view'">{{key}}
          </cjm-radio>
        </cjm-radio-group>
      </cjm-form-item>
      <cjm-form-item label="允许物流查询" prop="allowLogisticsQuery" required class="cjm-form-item-long">
        <cjm-radio-group v-model="form.allowLogisticsQuery">
      ...
      <cjm-form-item label="物流码位数" prop="logisticsCodeLength" required
                     class="cjm-form-item-long" v-if="!form.codeType.includes(enums.codeType.MINGANMA) && !form.codeType.includes(this.enums.codeType.PESTICIDE)">
      ...
      <cjm-form-item label="物流信息卡片" prop="enabledLogisticsCardInfo" required class="cjm-form-item-long">
        <cjm-radio-group v-model="form.enabledLogisticsCardInfo">
      ...
      <cjm-form-item label="显示溯源信息" prop="enabledOriginInfo" required class="cjm-form-item-long">
        <cjm-radio-group v-model="form.enabledOriginInfo">
          <cjm-radio :label="value" v-for="(value,key) in yesOrNo" :key="value"
                     :disabled="operation==='approve' || operation==='view'">
            {{key}}
          </cjm-radio>
