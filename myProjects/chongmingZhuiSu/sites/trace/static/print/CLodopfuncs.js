(function (win) {
  var CLODOP = {
  strWebPageID:"C70mt38",strTaskID:"",strHostURI:"http://localhost:18000",
  VERSION:"6.2.1.8",IVERSION:"6218",CVERSION:"2.1.6.3",HTTPS_STATUS:0,VERSION_EXT:false,
  ...
  FORMAT:
          function(oType, oValue) {
                  if (this.blWorking) {alert("It's Working... just a moment.");return null;}
                  var tResult=null;
