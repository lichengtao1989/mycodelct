  ...
  <div class="listout">
    <div class="listleft">
      <div class="news-active border">
        <div class="model-title">质量监管</div>
    ...
    <div class="listright">
      <listview :listtype="5" :toptitle="toptitle" :listInfoAry="listAry"></listview>
...
export default {
  ...
  created() {},
  mounted() {
    let queryObj = { pageSize: 10, pageNum: 1, Type: 1 };
    this.listInfo(queryObj);
  }
};
</script>
