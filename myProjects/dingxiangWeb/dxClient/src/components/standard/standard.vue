  ...
  <div class="listout">
    <div class="listleft">
      <div class="news-active border">
        <div class="model-title">标准规范</div>
    ...
    <div class="listright">
      <listview :listtype="11" :toptitle="toptitle" :listInfoAry="listAry"></listview>
...
export default {
  ...
  created() {},
  mounted() {
    let queryObj = { pageSize: 10, pageNum: 1, Type: 7 };
    this.listInfo(queryObj);
  }
};
</script>
