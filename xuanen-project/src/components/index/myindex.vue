<template>
  <div class="indexpage">
    ...
    <div class="topone">
      <div class="topleft">
        <tabbox @changeTabFn="changeTabFn" :listInfoAry="listInfoAry" :linewidth="334" :textAry="arytext" :rightval="15" :ovwidthval="188" :padleftval="18" :widthval="353" :tabwidth="105"
          :heightval="257"></tabbox>
      </div>
      <div class="topmid">
...
.topone {
  ...
  .topmid {
    @include wh(477px, 259px);
    @include ov;
  }
  .topright {
    @include wh(353px, 257px);
    border: 1px solid #128f40;
    @include po;
    right: 0;
    top: 0;
