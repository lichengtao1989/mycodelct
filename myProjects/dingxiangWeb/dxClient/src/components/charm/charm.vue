  ...
  <div class="listout">
    <div class="listleft">
      <div class="news-active border">
        <div class="model-title">魅力定襄</div>
    ...
    <div class="listright">
      <listview :listtype="10" :toptitle="toptitle" :listInfoAry="listAry"></listview>
...
export default {
  ...
  created() {},
  mounted() {
    let queryObj = { pageSize: 10, pageNum: 1, Type: 6 };
    this.listInfo(queryObj);
  }
};
</script>
