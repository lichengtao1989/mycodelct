<template>
  <div class="nz-image-upload">
    <template v-if="isShowItems">
      <image-upload-item v-for="(path,index) in val" :key="path+'-'+index" :item-style="itemStyle" :uploadUrl="uploadUrl" :value="path" @uploadSuccess="editPath(index,$event)" @del-image="delImage(index)"></image-upload-item>
