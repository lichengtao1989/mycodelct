...
export default {
  install(Vue) {
    ...
    const { Tree, Table, Button, Form, FormItem, Radio, RadioButton, RadioGroup, Checkbox, CheckboxGroup, Select, Option, Input, DatePicker, Dialog, Progress, Cascader, Pagination, Tabs, TabPane, Autocomplete, Upload, Steps, Step, Popover } = ELEMENT;
    //
    ...
    Vue.component('nz-upload', Upload);
    Vue.component('nz-steps', Steps);
    Vue.component('nz-step', Step);
    Vue.component('nz-popover', Popover);
    //
