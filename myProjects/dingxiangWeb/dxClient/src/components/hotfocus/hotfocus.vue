  ...
  <div class="listout">
    <div class="listleft">
      <div class="news-active border">
        <div class="model-title">热点聚焦</div>
    ...
    <div class="listright">
      <listview :listtype="6" :toptitle="toptitle" :listInfoAry="listAry"></listview>
...
export default {
  ...
  created() {},
  mounted() {
    let queryObj = { pageSize: 10, pageNum: 1, Type: 2 };
    this.listInfo(queryObj);
  }
};
</script>
