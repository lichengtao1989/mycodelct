...
export default {
  ...
  mounted() {
    ...
    if (urls.indexOf('kf315') > -1) {
      srcval = `http://login.kf315.net/?callback=http://app315.kf315.net/module/index/landing.html?systemId=${this.systemId}&btncolor=10cec6&iconcolor=10cec6`;
      ...
      srcval = `http://login.app315.net/?AudsId=t&callback=http://cjm.app315.net/module/index/landing.html?systemId=${this.systemId}&btncolor=10cec6&iconcolor=10cec6`;
    }
