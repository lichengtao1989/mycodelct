  ...
  <div class="listout">
    <div class="listleft">
      <div class="news-active border">
        <div class="model-title">农情预警</div>
    ...
    <div class="listright">
      <listview :listtype="9" :toptitle="toptitle" :listInfoAry="listAry"></listview>
...
export default {
  ...
  created() {},
  mounted() {
    let queryObj = { pageSize: 10, pageNum: 1, Type: 5 };
    this.listInfo(queryObj);
  }
};
</script>
